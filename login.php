    ...
    <div class="login-card">
        ...
        <form action="login_process.php" method="POST" autocomplete="off">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="username" maxlength="13" value="1234567891234" required autofocus>
            </div>

            <div class="mb-3">
                <label for="password" class="form-label">รหัสผ่าน (4 ตัวท้ายของเลขบัตร)</label>
                <input type="password" class="form-control" id="password" name="password" maxlength="16" value="1234" required>
            </div>
