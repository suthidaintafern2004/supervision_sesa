                ...
                <table class="table table-hover align-middle mb-0 w-100">
                    <thead style="position: sticky; top: 0; z-index: 10;">
                        <tr>
                            ...
                            <th style="width: 15%;">กลุ่มสาระ</th>
                ...
                <form id="addTeacherForm">
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-bold small text-muted">กลุ่มสาระการเรียนรู้</label>
                                <select class="form-select" name="subjectgroup_id" required>
                                    <option value="">-- เลือกกลุ่มสาระการเรียนรู้ --</option>
                                    <?php foreach ($subjectgroups as $sg): ?>
                                        <option value="<?= $sg['subjectgroup_id'] ?>">
        ...
        function renderRows(teachers) {
            ...
            <tr>
                <td class="fw-bold text-dark">
                    ${(t.prefix_name || '')} ${t.f_name} ${t.l_name}
                </td>
                <td>
                ...
                <td class="small text-muted">${t.subjectgroup_name || '-'}</td>
                <td>${t.school_name || '-'}</td>
                <td class="text-center">
                    <div class="btn-group">
                        <button class="btn btn-warning btn-sm text-white"
                            onclick="openTeacherEditModal('${t.t_pid}')">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-danger btn-sm"
                            onclick="deleteTeacher('${t.t_pid}')">
        ...
        function openTeacherEditModal(t_pid) {
            ...
            fetch('fetch_teacher.php?t_pid=' + encodeURIComponent(t_pid))
                ...
                .then(d => {
                    ...
                    document.getElementById("edit_subjectgroup_id").value = t.subjectgroup_id || '';
